...
// Answer -->
//(A)Undefined :- 1) A variable declare but there is no value is given, its value is undefined.
//                2) Javascript automatically gives undefined.
//                3) Typeof undefined returs "undefined"
let x1 
console.log(x1)  // output:- undefined 

//(B)Null :- 1) Null means we intentionally assig an empty or "Nothing"
//           2) there is no value to valriable
//           3) Typeof Null returs "Object"
let y2 = null
console.log(y2)  //output:-null
